...
import com.forest.mall.account.service.MemberService;
...
public class MemberController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("account:member:list")
    ...
    // @RequiresPermissions("account:member:info")
     ...
     */
    @RequestMapping("/save")
    // @RequiresPermissions("account:member:save")
    ...
    // @RequiresPermissions("account:member:update")
    ...
    // @RequiresPermissions("account:member:delete")
